 ...
 * generated in the cxf.service package. 
...
public class ObjectFactory {
    ...
    private final static QName _QueryWeather_QNAME = new QName("http://interfaces.cxf/", "queryWeather");
    private final static QName _QueryWeatherResponse_QNAME = new QName("http://interfaces.cxf/", "queryWeatherResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: cxf.service
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://interfaces.cxf/", name = "queryWeather")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://interfaces.cxf/", name = "queryWeatherResponse")
