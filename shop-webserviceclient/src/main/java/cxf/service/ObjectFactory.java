...
public class ObjectFactory {
    ...
    private final static QName _QueryWeather_QNAME = new QName("http://interfaces/", "queryWeather");
    private final static QName _QueryWeatherResponse_QNAME = new QName("http://interfaces/", "queryWeatherResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://interfaces/", name = "queryWeather")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://interfaces/", name = "queryWeatherResponse")
