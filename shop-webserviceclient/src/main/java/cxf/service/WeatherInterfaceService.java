 ...
 * 2018-01-31T11:11:46.726+08:00
 * Generated source version: 3.1.14
 * 
 */
@WebServiceClient(name = "WeatherInterfaceService", 
                  wsdlLocation = "http://127.0.0.1:8080/weather?wsdl",
                  targetNamespace = "http://interfaces/") 
public class WeatherInterfaceService extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://interfaces/", "WeatherInterfaceService");
    public final static QName WeatherInterfacePort = new QName("http://interfaces/", "WeatherInterfacePort");
    static {
        URL url = null;
        try {
            ...
            java.util.logging.Logger.getLogger(WeatherInterfaceService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://127.0.0.1:8080/weather?wsdl");
        }
        WSDL_LOCATION = url;
    }
