...
public class ObjectFactory {
    ...
    private final static QName _QueryWeatherResponse_QNAME = new QName("http://service/", "queryWeatherResponse");
    private final static QName _QueryWeather_QNAME = new QName("http://service/", "queryWeather");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service/", name = "queryWeatherResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service/", name = "queryWeather")
