 ...
 * 
 */
@WebServiceClient(name = "WebServiceImplService", targetNamespace = "http://service/", wsdlLocation = "http://localhost:8080/weather?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/weather?wsdl");
